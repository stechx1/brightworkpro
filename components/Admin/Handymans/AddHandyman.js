...
const AddHandyman = ({navigation}) => {
  ...
  const uploadImage = async () => {
    // const uploadUri = image.filename;
    ...
    const StorageRef = storage().ref(`profile/${image}`);
            ...
            <View style={{padding: 10}}>
              {image !== '' ? (
                ...
                <TouchableOpacity onPress={handleImage}>
                  <MaterialComm name="image-plus" size={50} color="black" />
                </TouchableOpacity>
              )}
            </View>
          </View>
          {loading ? (
            ...
            <TouchableOpacity
              ...
              <Button
                ...
                buttonColor="#4e75ec"
                style={{padding: 5}}
                icon={() => <Icon name="pluscircleo" size={23} color="white" />}
                mode="contained">
                Add
              </Button>
            </TouchableOpacity>
